...
The strategic regime remains **mild risk-off with a defensive USD bias**. Current live portfolio value is **99,518.16 USD**, with unrealized P&L of **-481.46 USD** and cash of **35,826.69 USD**. The technical overlay currently reads: **overlay available**.
...
The official policy backdrop still supports a defensive dollar bias. The Fed maintained the target range at **3.50–3.75%** on 18 March 2026. The ECB deposit facility remains **2.00%**. The BoE maintained Bank Rate at **3.75%** on 19 March 2026 and explicitly highlighted the inflationary and growth risks from the Middle East energy shock. The RBA cash rate target is **4.10%** effective 18 March 2026. The RBNZ OCR remains **2.25%**. The SNB policy rate remains **0.00%**. The BoJ guideline continues to encourage the uncollateralized overnight call rate at around **0.75%**. That combination leaves USD well supported on carry, liquidity, and current risk conditions, while CHF remains the cleaner second-line defensive sleeve.
...
The correct portfolio posture remains **defense first, optionality second, high-beta last**. There is still no new evidence that justifies another rebalance. USD remains the strongest core anchor. CHF remains the cleaner secondary defensive allocation than JPY on this run. JPY stays in the portfolio at reduced size. AUD remains a staged allocation. The most important same-day conclusion is that the macro regime has tightened around higher energy-risk sensitivity, which reinforces rather than weakens the defensive portfolio stance.
...
|---|---:|---:|---:|---:|---|
| 2026-03-25 | 100,000 | 0.0000 | 0.0000 | 0.0000 | 2026-03-25T12:08:31Z |
...
| USD cash | — | Long USD cash | 2026-03-25 | 1.00000000 | 1.00000000 | 35,826.69 | 0 | 36.00 | Buy |
...
- Portfolio engine state: live; last valuation timestamp 2026-03-26T19:25:44Z
