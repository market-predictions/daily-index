...
The ranking still supports **USD first, CHF second**, with **JPY retained as a smaller staged hold**, **AUD retained as a staged hold**, and **EUR / GBP kept in reduce territory**. Relative to the most recent stored FX run, the live valuation has improved modestly from **99,551.58 USD** to **99,559.41 USD**, while the technical overlay remains broadly defensive and still favors USD over most alternatives.

The macro backdrop remains supportive for a defensive allocation. The Federal Reserve maintained a **3.50–3.75%** target range on 18 March 2026. The ECB deposit facility remains **2.00%**. The Bank of England maintained Bank Rate at **3.75%** on 19 March 2026 and highlighted energy-shock risks from the Middle East. The latest indexed RBA policy decision remains the 3 February 2026 increase to **3.85%**. The RBNZ OCR remains **2.25%**. The SNB left its policy rate unchanged at **0.00%** on 19 March 2026. The BoJ’s latest policy guideline still encourages the uncollateralized overnight call rate to remain at around **0.75%**.
...
- **Change vs prior run:** no additional position changes executed on this run; this version reflects fresher valuation and fresher overlay interpretation only.
...
- **Commodity impulse:** Supportive for CAD in macro terms; tactically constructive for AUD on technicals but no longer strongly so; adverse for major oil importers
...
The official policy backdrop still supports a defensive USD bias. The Fed maintained the federal funds target range at **3.50–3.75%** on 18 March 2026. The ECB deposit facility remains **2.00%**. The BoE maintained Bank Rate at **3.75%** on 19 March 2026 and explicitly highlighted the inflationary and activity risks from the Middle East energy shock. The latest indexed RBA policy decision remains the 3 February move to **3.85%**. The RBNZ OCR remains **2.25%**. The SNB policy rate remains **0.00%**. The BoJ continues to encourage the uncollateralized overnight call rate to remain at around **0.75%**. That leaves USD well supported on carry, liquidity, and risk conditions, while CHF remains the cleaner second-line defensive sleeve.
...
| Swiss defensive role with intervention risk | active / investable | CHF remains the cleaner second-line defensive sleeve because the macro case is intact, even though the latest technical confirmation is only negative rather than neutral |
...
| Commodity FX recovery | active / watch | AUD remains mixed rather than clearly positive, while CAD’s near-term confirmation remains softer than the broader macro case |
...
| EM carry under controlled volatility | weakening / watch | MXN remains carry-positive on macro logic, but the latest overlay is now negative rather than mixed |
...
The correct portfolio posture remains **defense first, optionality second, high-beta last**. There is still no new evidence that justifies another rebalance. USD remains the strongest core anchor. CHF remains the cleaner secondary defensive allocation than JPY on this run. JPY stays in the portfolio at reduced size. AUD remains a staged allocation, but the latest overlay still argues for patience rather than fresh aggression. MXN’s technical picture has softened versus earlier same-day runs, which further reinforces the case for disciplined sizing and a continued preference for USD cash and CHF over higher-beta sleeves.
...
**MXN — Hold / stage**
MXN remains carry-positive on macro logic, but the latest overlay has now softened from mixed to negative. That keeps MXN in the portfolio, but with an even stronger case for disciplined sizing rather than aggressive adding.
