...
The strategic regime remains **mild risk-off with a defensive USD bias**. No new portfolio rebalance is justified versus the latest 25 March implementation state. Live portfolio value is **99,785.42 USD**, cash is **35,922.85 USD**, and unrealized P&L is **-214.38 USD**. The ranking remains **USD first, CHF second**, with **JPY retained as a smaller staged hold**, **AUD retained as a staged hold**, and **EUR / GBP kept in reduce territory**.

The main same-day refinement is in the policy backdrop rather than the portfolio engine. The Fed maintained **3.50–3.75%** on 18 March 2026, the BoE maintained **3.75%** on 19 March 2026 while highlighting the energy shock from the Middle East conflict, and the RBA cash rate target is now **4.10%** effective 18 March 2026. That keeps the portfolio conclusion unchanged: **defense first, optionality second, high-beta last**.
