...
The strategic regime remains **mild risk-off with a defensive USD bias**. Live portfolio value is now **99,518.16 USD**, cash is **35,826.69 USD**, and unrealized P&L is **-481.46 USD**. The live overlay timestamp is **2026-03-26T19:25:44Z** and the ranking still supports **USD first, CHF second**, with **JPY retained as a smaller staged hold**, **AUD retained as a staged hold**, and **EUR / GBP kept in reduce territory**.

The same-day change is not a new strategic rebalance but a fresher marked-to-market update and a cleaner policy backdrop. The Fed’s latest indexed policy release still shows a **3.50–3.75%** target range. The ECB deposit facility remains **2.00%**. The BoE held Bank Rate at **3.75%** on 19 March 2026 and explicitly flagged the inflationary and growth risks from the Middle East energy shock. The RBNZ OCR remains **2.25%**. The SNB policy rate is **0.00%**. The BoJ still guides the uncollateralized overnight call rate at around **0.75%**. The latest indexed RBA policy decision remains the 3 February 2026 increase to **3.85%**. That mix still supports the existing portfolio conclusion: **defense first, optionality second, high-beta last**.
...
Engine overlay timestamp: **2026-03-26T19:25:44Z**.

- Net asset value (USD): **99,518.16**
- Cash (USD): **35,826.69**
- Gross exposure (USD): **63,691.66**
- Net exposure (USD): **63,691.66**
- Realized P&L (USD): **-0.19**
- Unrealized P&L (USD): **-481.46**
- Daily return (%): **-0.0001**
- Since inception return (%): **-0.4818**
- Max drawdown (%): **-0.4818**
...
- Invested market value (USD): **63,691.66**
- Cash (USD): **35,826.69**
- Total portfolio value (USD): **99,518.16**
- Since inception return (%): **-0.4818**
- Base currency: **USD**
...
|---|---|---|---|---:|---:|---:|---:|---:|---|
| CHF | USD/CHF -> CHFUSD | Long CHF | 2026-03-25 | 1.26782909 | 1.25726068 | 12,937.37 | -108.75 | 26.53 | Build on weakness |
| JPY | USD/JPY -> JPYUSD | Long JPY | 2026-03-25 | 0.00629629 | 0.00625771 | 12,937.37 | -79.77 | 20.97 | Hold / stage |
| CAD | USD/CAD -> CADUSD | Long CAD | 2026-03-25 | 0.72498197 | 0.72213115 | 9,951.82 | -39.29 | 13.89 | Hold |
| MXN | USD/MXN -> MXNUSD | Long MXN | 2026-03-25 | 0.05639478 | 0.05586611 | 7,961.46 | -75.34 | 10.00 | Hold / stage |
| AUD | AUD/USD -> AUDUSD | Long AUD | 2026-03-25 | 0.69671035 | 0.68873000 | 7,961.46 | -92.25 | 9.09 | Hold / stage |
| GBP | GBP/USD -> GBPUSD | Long GBP | 2026-03-25 | 1.34205645 | 1.33226000 | 6,966.28 | -51.22 | 7.37 | Reduce |
| EUR | EUR/USD -> EURUSD | Long EUR | 2026-03-25 | 1.16075979 | 1.15269000 | 4,975.91 | -34.84 | 5.00 | Reduce |
| USD cash | — | Long USD cash | 2026-03-25 | 1.00000000 | 1.00000000 | 35,826.69 | 0.00 | 36.00 | Buy |
...
- Current total portfolio value: 99,518.16
- Cash: 35,826.69
- Holdings:
  - USD cash 36%
  - JPY 13%
...
- Technical overlay state: available same-day; USD positive, EUR strong negative, GBP strong negative, JPY strong negative, AUD mixed, CAD negative, NZD negative, MXN mixed, ZAR negative
- Portfolio engine state: live; last valuation date 2026-03-26 and latest overlay timestamp 2026-03-26T19:25:44Z
